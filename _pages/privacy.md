...
browser automatically transmits to us in "server log files". These are: Browser
type and browser version, Operating system used, Referrer URL, Host name of the
accessing computer, Time of the server request, IP address. This data will not
be combined with data from other sources. This type of information will be
statistically analyzed by us if necessary to optimize our website and its
...
legitimate interest ([Art. 6 §1 (f) GDPR](https://gdpr-info.eu/art-6-gdpr/)).
...
measures ([Art. 6 §1 (b) GDPR](https://gdpr-info.eu/art-6-gdpr/)).
...
#### Legal basis
Based on your express consent ([Article 6 (1) a
...
#### Type and purpose
This website uses Google Analytics, a web analytics service of Google LLC, 1600
...
to a Google server in the U.S. and stored there. However, due to the activation
of IP anonymization on these websites, your IP address will be truncated
beforehand by Google within the member states of the European Union or in other
...
U.S. and truncated there. On behalf of the operator of this website, Google will
use this information to evaluate your use of the website, summarize reports on
website activities and provide other services related to website and Internet
usage to the website operator. The IP address transferred from your browser as
part of Google Analytics will not be combined with other data from Google.
...
#### Legal basis
The processing of the data occurs on the basis of the user’s consent ([Art. 6
§1 (a) GDPR](https://gdpr-info.eu/art-6-gdpr/)).
...
associated data transfer to Google ([Art. 6 §1 (a)
